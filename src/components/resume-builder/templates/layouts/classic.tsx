...
export function ClassicLayout({
  ...
  if (data.basics.phone) contactItems.push({ icon: <PhoneIcon />, text: data.basics.phone })
  if (data.basics.email) contactItems.push({ icon: <AtSignIcon />, text: data.basics.email })
