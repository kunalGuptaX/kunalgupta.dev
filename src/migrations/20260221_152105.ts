...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "resume_projects_tech_stack" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar NOT NULL
  ...
  CREATE INDEX "resume_experience_bullets_order_idx" ON "resume_experience_bullets" USING btree ("_order");
  CREATE INDEX "resume_experience_bullets_parent_id_idx" ON "resume_experience_bullets" USING btree ("_parent_id");
  ...
  CREATE INDEX "resume_projects_tech_stack_order_idx" ON "resume_projects_tech_stack" USING btree ("_order");
  CREATE INDEX "resume_projects_tech_stack_parent_id_idx" ON "resume_projects_tech_stack" USING btree ("_parent_id");
